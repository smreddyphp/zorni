            ...
            <div class="col-md-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Send Push Notifications</h4>
                    </div>
...
<form method="post" action="">
    <div class="form-group">
        ...
        <h5 style="color:red"><?php echo form_error('send_notification'); ?></h5>
        <select name="send_notification" class="form-control input-lg" value="">
            <option value="">Select Option</option>
            <option value="2">Doctors</option>
            <option value="4">Free Dentals</option>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control input-lg" name="title" placeholder=" title" value="">        
    </div>
    <div class="form-group">
        <label>Message</label>
        <h5 style="color:red"><?php echo form_error('message'); ?></h5>
        <textarea class="form-control" id="edito1" rows="3" cols="4" name="message" id="" placeholder="Type Here..."></textarea>
    </div>
    	<button type="submit" class="btn btn-default">Send Push Notifications</button>
</form>
                    </div>
                </div>
            </div>
