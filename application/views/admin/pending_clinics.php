            ...
            <div class="col-md-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Approval Clinics</h4>
                    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($clinics as $row)
                                {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?= $row->mobile ?></td>
                                        <td>
                                           <button type="submit" value = "1" class="btn btn-success btn-sm br2 fs12" name="status" onclick="statusCheck(this.value,'<?= $row->user_id ?>')">Approve</button>                                      
    					   <button type="submit" value = "3" class="btn btn-success btn-sm br2 fs12" name="status" onclick="statusCheck(this.value,'<?= $row->user_id ?>')">Reject</button> 
                                      </td>
                                        <td><a href="<?php echo base_url(); ?>users/user_view_profile/<?= $row->user_id ?>"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span> View</button><a href="<?php echo base_url(); ?>admin/delete_clinic/<?= $row->user_id ?>"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button></a></td>
                                    </tr>
                                    <?php                                   
                                }
                                ?>
...
if(confirm("Are you sure you want to Approve or Reject this user ?"))
  {
   $.ajax({
