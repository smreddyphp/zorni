            ...
            <div class="col-md-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">All Clinics</h4>
                    </div>
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered">
                            <thead>
                            <tr>
                                <th width="100px" nowrap>Click Name</th>
                                ...
                                foreach ($clinics as $row)
                                {
                                    ...
                                    <tr class="odd gradeX">
                                       ...
                                       <?php } ?>
                                        ...
                                        <td><a href="<?php echo base_url(); ?>admin/clinic_view/<?= $row->user_id ?>">
                                        <button type="button" name="user_id" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span>View</button>
                                      </form><a href="<?php echo base_url(); ?>admin/delete_clinic/<?= $row->user_id ?>"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button></a></td>
                                    </tr>
                                    <?php                                   
                                }
                                ?>
