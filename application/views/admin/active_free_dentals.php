            ...
            <div class="col-md-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">All Free Dentals</h4>
                    </div>
                                ...
                                foreach ($free_dentals as $row)
                                {
                                    ...
                                    <tr class="odd gradeX">
                                       ...
                                       <?php } ?>
                                        ...
                                        <td><a href="<?php echo base_url(); ?>admin/free_dental_view/<?= $row->user_id ?>"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span> View</button><a href="<?php echo base_url(); ?>admin/delete_free_dental/<?= $row->user_id ?>"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button></a></td>
                                    </tr>
                                    <?php                                   
                                }
                                ?>
