        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="widget widget-stats bg-red-darker">
                    ...
                    <div class="stats-info">
                        <h4>Total Registered Clinics</h4>
                        <p><?= $this->admin_model->count_users_based_on_auth_level(3) ?></p>
                    </div>
                    <div class="stats-link">
                        <a href="<?= base_url() ?>admin/get_active_clinics">View Detail <i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- end col-3 -->
            ...
            <div class="col-md-3 col-sm-6">
                <div class="widget widget-stats bg-blue-darker">
                    ...
                    <div class="stats-info">
                        <h4>Total Registerd Doctors</h4>
                        <p><?= $this->admin_model->count_users_based_on_auth_level(2) ?></p>
                    </div>
                    <div class="stats-link">
                        <a href="<?= base_url() ?>admin/get_active_doctors">View Detail <i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- end col-3 -->
            ...
            <div class="col-md-3 col-sm-6">
                <div class="widget widget-stats bg-purple-darker">
                    ...
                    <div class="stats-info">
                        <h4>Total Free Dentals</h4>
                        <p><?= $this->admin_model->count_users_based_on_auth_level(4) ?></p>
                    </div>
                    <div class="stats-link">
                        <a href="<?= base_url() ?>admin/active_free_dentals">View Detail <i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- end col-3 -->
            ...
            <div class="col-md-3 col-sm-6">
                <div class="widget widget-stats bg-green-darker">
                    ...
                    <div class="stats-info">
                        <h4>Total Users</h4>
                        <p><?= $this->admin_model->count_users_based_on_auth_level(1) ?></p>
                    </div>
                    <div class="stats-link">
                        <a href="<?= base_url() ?>admin/get_active_users">View Detail <i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- end col-3 -->
