                ...
                <ul class="nav nav-pills">
                    <li class="active">
                        <a href="#nav-pills-tab-1" data-toggle="tab">
                            <span class="visible-xs">User Profile</span>
                            <span class="hidden-xs">User Profile</span>
                        </a>
                    </li>
                    <li>
                        <a href="#nav-pills-tab-2" data-toggle="tab">
                            <span class="visible-xs">Medical Advice Requests</span>
                            <span class="hidden-xs">Medical Advice Requests</span>
                        </a>
                    </li>                                        
                    <li>
                        <a href="#nav-pills-tab-4" data-toggle="tab">
                            <span class="visible-xs">Clinic Booked Appointments</span>
                            <span class="hidden-xs">Clinic Booked Appointments</span>
                        </a>
                    </li>
                    <li>
                        <a href="#nav-pills-tab-5" data-toggle="tab">
                            <span class="visible-xs">Free Treatment Booked Appointments</span>
                            <span class="hidden-xs">Free Treatment Booked Appointments</span>
                        </a>
                    </li>
                </ul>
                            ...
                            <table class="table table-profile">
	                         ...
	                         ?>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo base_url(); ?>images/<?= $user_data->professional_license ?>" class="img-rounded" alt="Cinque Terre" style="width:100px;height:100px;"></td>
                                </tr>
                                <?php
                                }
                                ?>
            ...
            <div class="col-md-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Mdical Advices</h4>
                    </div>
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <th width="200px" nowrap>Document</th>
                            ...
                            <tbody>
                               <?php
                               $i = 1;
                                foreach ($medical_advices as $row)
                                {
                                    ?>
                                    <tr class="odd gradeX">
                                        <td><?= $i++ ?></td>               
                                        ...
                                        {
                                        ?>
                                         <img id="myImg_<?= $row->id ?>" src="<?= base_url() ?>medical_slips/<?= $row->medical_slip ?>" alt="<?= $row->medical_slip ?>" width="100" height="75">
					 ...
					 <!-- End Functions------------------>
                                        ...
                                        {
                                         ?>
                                         <a href="<?php echo base_url(); ?>admin/view_document/<?= $row->id ?>" target = "_blank"><button type="button" class="btn btn-success"><span class="fa fa-video-camera"></span></button></a>
                                         <?php
                                        }
                                        else if($row->file_type == "audio")
                                        {
                                        ?>
                                          <a href="<?php echo base_url(); ?>admin/view_document/<?= $row->id ?>" target = "_blank"><button type="button" class="btn btn-info"><span class="fa fa-volume-up"></span></button> </a>
                                        <?php                                        
                                        }
    						...
    						<a href="<?php echo base_url(); ?>users/user_view_profile/<?= $row->doctor_id ?>"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span> View</button> </a>
                                       </td>
                               ...
                               <?php
                                foreach ($appointments as $row)
                                {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        if(@$row->service)
                                        {
                                            echo $this->clinics_model->get_service_name_by_id($row->service)->service_name;
                                        }
                                         ?>
                                        <td>
                                        <?php if($row->status == 0)
                                  ...
                                  <?php
                                      ...
                                      <td><a href="<?php echo base_url(); ?>users/user_view_profile/<?= $row->booking_id ?>"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span> View</button>         
                                      <?php 
                                    }
                                    ?>                                    
                            </tbody>
            ...
            <div class="col-md-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Free Treatment Appointments</h4>
                    </div>
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered">
                            <thead>
                            ...
                            <tbody>
                               <?php
                                foreach ($freedental_appointments as $row)
                                {
                                    ?>
                                    <tr class="odd gradeX">
                                        <td><?= $row->name ?></td>                                        
