                            ...
                            <tbody>
                                ...
                                foreach ($users as $row)
                                {
                                    ...
                                    <tr class="odd gradeX">
                                       ...
                                       <?php } else { ?>
                                       <button type="submit" value = "<?= $row->status ?>" class="btn btn-success btn-sm br2 fs12" name="status" onclick="statusCheck(this.value,'<?= $row->user_id ?>')">Dactivated</button>
                                       <?php } ?>
                                      </td>
                                        <td><a href="<?php echo base_url(); ?>admin/user_view_profile/<?= $row->user_id ?>"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span> View</button><a href="<?php echo base_url(); ?>admin/delete_user/<?= $row->user_id ?>"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button></a></td>
                                    </tr>
                                    <?php                                   
                                }
                                ?>
