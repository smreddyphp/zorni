                ...
                <ul class="nav nav-pills">
                    <li class="active">
                        <a href="#nav-pills-tab-1" data-toggle="tab">
                            <span class="visible-xs">Free Dental Profile</span>
                            <span class="hidden-xs">Free Dental Profile</span>
                        </a>
                    </li>
                    <li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-profile">
	                         ...
	                         ?>
                                ...
                                ?>
                                <tr>
                                    <td class="field"><b>ID Card :</b></td>
                                    <td><img src="<?php echo base_url(); ?>idcards/<?= $user_data->id_card ?>" class="img-rounded" alt="Cinque Terre" height="100px" width="100px"></td>
                                </tr>
                                <?php
                                }
                                ?>
                                ...
                                ?>
                                <tr>
                                    <td class="field"><b>Starting Date :</b></td>
                                    <td><?= $user_data->package_buy_date ?></td>
                                </tr>
                                <?php
                                }
                                ?>
                                ...
                                ?>
                                <tr>
                                    <td class="field"><b>Ending Date :</b></td>
                                    <td><?= $user_data->package_expire_date ?></td>
                                </tr>
                                <?php
                                }
                                ?>
                               ...
                               <?php
                                foreach ($appointments as $row)
                                {
                                  ...
                                  <?php
                                      ...
                                      <td><a href="<?php echo base_url(); ?>users/user_view_profile/<?= $row->user_id ?>"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span> View</button></a> <a href="<?php echo base_url(); ?>admin/free_dental_chat_view/<?= $row->user_id ?>/<?= $user_data->user_id ?>"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span>Chat View</button></a></td>  
                                      <?php 
                                    }
                                    ?>                                    
                            </tbody>
                            ...
                            <tbody>
                                ...
                                foreach ($ratings as $row)
                                {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?= $row->ratings ?></td>
                                        <td><?= $row->date ?></td>
                                        <td><a href="<?php echo base_url(); ?>users/user_view_profile/<?= $row->user_id ?>"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span> View</button></a></td>         
                              <?php                                   
                                }
                                ?>
                            </tbody>
