            ...
            <div class="col-md-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Confirmed Advice Requests</h4>
                    </div>
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <th width="50px" nowrap>Status<th>                                                               
                                <th>Action</th>
                            </tr>
                            </thead>
                            <tbody>
                               <?php
                               $i = 1;
                                foreach ($confirmed_medical_advices as $row)
                                {
                                    ?>
                                    <tr class="odd gradeX">
                                        <td><?= $i++ ?></td>                                        
                                        ...
                                        <td>
                                        	<button class = "btn btn-info">Conformed</button><!--<button type="submit" value = "1" class="btn btn-success btn-sm br2 fs12" name="status" onclick="statusCheck(this.value,'<?= $row->id ?>')">Confirm</button>-->   
                                        <td>
    						...
    						<a href="<?php echo base_url(); ?>users/user_view_profile/<?= $row->user_id ?>"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span> View</button> </a>                                      
                                      ...
                                      <td>
                                         <a href="<?php echo base_url(); ?>users/chat/<?= $row->user_id ?>"><button type="button" class="btn btn-info"><i class="fa fa-comments"></i> Chat</button></a></td>            
