            ...
            <div class="col-md-10">                
                ...
                <div class="tab-content">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" action="<?php echo base_url('doctors/update_profile');?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="username">User Name * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="username" value="<?= $doctor_details->username ?>" required="required" />
                                </div>
                            </div>                            
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="email">Email * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="email" value="<?= $doctor_details->email ?>" readonly/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="mobile">Mobile:</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="number" name="mobile" value="<?= $doctor_details->mobile ?>" required="required"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="mobile">Consultation Fees:</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="number" name="dr_fees" value="<?= $doctor_details->dr_fees ?>" required="required"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="website">Location:</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="location" value="<?= $doctor_details->location ?>" required="required" />
                                    <input class="form-control" type="hidden" name="image" value="<?= $doctor_details->image ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="website">About Me:</label>
                                <div class="col-md-6 col-sm-6">
                                    <textarea class="form-control" name="about_dr" value="" required="required"/><?= $doctor_details->about_dr ?>
                                    </textarea>
                                </div>
                            </div>
                            <div class="form-group">
