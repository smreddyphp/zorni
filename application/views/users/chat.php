...
$.ajax({ url:'<?php echo base_url();?>/users/chat_view',
	type:'POST',
...
<div class="content-wrapper">
                        ...
                        <div class="col-xl-6">
                            <div class="card col-lg-8">
                                <div class="card-header">
                                    <h5 class="card-header-text">Chat Box</h5>
                                </div>
		...
		<ul class="chat" id="chatmsg">			
                ...
                <div class="panel-footer" style="width:720px">
                    ...
                    <form action="<?php echo base_url();?>/users/chat_send/<?=$this->uri->segment(3)?>" method="post" enctype="multipart/form-data" id="chat_name">
                           <div class="input-group">
                                <div class="col-sm-4">
                                    <label style="font-size: 15px;">Send File</label>
                                </div>
                                <div class="col-sm-8">
                                <input type="file" name="chat_file" accept=".png, .jpg, .jpeg,.mp4,.mp3,.mov,.wmv">     
                                  </div>  
                        ...
                        <div class="input-group">
                             <input id="msg_val" type="text"  class="form-control input-sm" placeholder="Type your message here..." />
                                 ...
                                 <input type="submit" value="Send" class="btn btn-warning btn-sm" id="btn-chat" onclick="submitdata()">
