            ...
            <div class="col-md-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Post Tweet</h4>
                    </div>
...
<form method="post" action="">
    <div class="form-group">
        <label>Title</label>
        <h5 style="color:red"><?php echo form_error('title'); ?></h5>
        <input type="text" class="form-control input-lg" name="title" placeholder="Add title" value="<?php if(isset($tweet->tweet_title)){echo $tweet->tweet_title; }else{ echo set_value('title'); }?>">
        <input type="hidden" class="form-control input-lg" name="id" placeholder="Add title" value="<?php if(isset($tweet->id)){echo $tweet->id; }?>">
    </div>
    <div class="form-group">
        <label>Title (Arabic)</label>
        <h5 style="color:red"><?php echo form_error('title_ar'); ?></h5>
        <input type="text" class="form-control input-lg" name="title_ar" placeholder="Add title" value="<?php if(isset($tweet->tweet_title_ar)){echo $tweet->tweet_title_ar; }else{ echo set_value('title_ar'); }?>">        
    </div>
    <div class="form-group">
        <label>Body</label>
        <h5 style="color:red"><?php echo form_error('body'); ?></h5>
        <textarea class="form-control" id="editor1" rows="3" cols="4" name="body" id="" placeholder="Type Here..."><?php if(isset($tweet->tweet)){echo $tweet->tweet; }else{ echo set_value('body'); }?></textarea>
    </div>
    <div class="form-group">
        <label>Body (Arabic)</label>
        <h5 style="color:red"><?php echo form_error('body_ar'); ?></h5>
        <textarea class="form-control" id="editor2" rows="3" cols="4" name="body_ar" id="" placeholder="Type Here..."><?php if(isset($tweet->tweet_ar)){echo $tweet->tweet_ar; }else{ echo set_value('body_ar'); }?></textarea>
    </div>
    	<button type="submit" class="btn btn-default">POST TWEET</button>
</form>
                    </div>
                </div>
            </div>
