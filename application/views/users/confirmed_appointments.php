                    ...
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <th width="100px" nowrap>Insurance</th>
                            ...
                            <tbody>
                               <?php
                                foreach ($confirmed_appointments as $row)
                                {
                                    ?>
                                    <tr class="odd gradeX">
                                        <td><?= $row->name ?></td>
                                        ...
                                        <td>
                                            ...
                                            {
                                                echo $this->db->query("select * from accepted_insurances where id ='".$row->insurance."'")->row()->insurance_name;
                                            }
                                            ?>
                                            </td>
                                        <td>
                                      ...
                                      <td>
                                          <button type="submit" value = "4" class="btn btn-success btn-sm br2 fs12" name="status" onclick="statusCheck(this.value,'<?= $row->id ?>')">Completed</button> 
                                      <a href="<?php echo base_url(); ?>users/user_view_profile/<?= $row->user_id ?>"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span> View</button></a>  <a href="<?php echo base_url(); ?>users/chat/<?= $row->user_id ?>"><button type="button" class="btn btn-info"><i class="fa fa-comments"></i> Chat</button></a>
                                      </td>        
                                      <?php 
                                    }
                                    ?>                                    
