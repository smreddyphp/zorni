            ...
            <div class="col-md-10">                
                ...
                <div class="tab-content">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" action="<?php echo base_url('free_dentals/update_profile');?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="fullname">User Name * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="username" value="<?= $free_dental_details->username ?>" required="required" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="email">Email * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="email" value="<?= $free_dental_details->email ?>" readonly/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="website">Mobile:</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="number" name="mobile" value="<?= $free_dental_details->mobile ?>" required="required"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="website">About Me:</label>
                                <div class="col-md-6 col-sm-6">
                                    <textarea class="form-control" name="about_dr" required="required"/><?= $free_dental_details->about_dr ?>
                                    </textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="location" value="<?= $free_dental_details->location ?>" required="required" />
                                    <input class="form-control" type="hidden" name="image" value="<?= $free_dental_details->image ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="dentals">Dentals:</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="dentals" value="<?= $free_dental_details->dentals ?>" required="required"/>
                                </div>
                            </div>
                            <div class="form-group">
