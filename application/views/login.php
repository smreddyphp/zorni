...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/login_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Dec 2017 10:11:24 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>Zorni Admin | Login Page</title>
...
<div id="page-container" class="fade">
    ...
    <div class="login login-v2" data-pageload-addclass="animated fadeIn">
        ...
        <div class="login-header">
            <div class="brand">
                <img src="<?php echo base_url(); ?>assets/app_logo.png" height="42" width="42"> Zorni
                <small>zorni</small>
            </div>
            <div class="icon">
        ...
        <div class="login-content">
            ...
            ?>            
            <form action="<?php echo base_url(); ?>users/login" method="POST" class="margin-bottom-0">
...
<!-- ================== BEGIN PAGE LEVEL JS ================== -->
<script src="<?php echo base_url(); ?>assets/js/login_v2_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/login_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Dec 2017 10:16:51 GMT -->
</html>